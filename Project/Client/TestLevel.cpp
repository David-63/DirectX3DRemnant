...
void CreateTestLevel()
{
	...
	//	SpawnGameObject(pObj, Vec3(40.f, 100.f, 40.f), 2);
		...
		Ptr<CPrefab> fab = CResMgr::GetInst()->Load<CPrefab>(L"prefab\\prefab01.pref", L"prefab\\prefab01.pref");
		fab->PrefabLoad(L"prefab\\prefab01.pref");
