...
void CreateTestLevel()
{
	...
	//{
	//	Ptr<CMeshData> data = CResMgr::GetInst()->LoadFBX(L"fbx\\Undying\\Wasteland_Undying_Melee_Turn180_R.fbx");
	//		CGameObject* obj = data->Instantiate();
	//		obj->Animator3D()->SimpleGen(L"animclip\\Undying_Turn180_R.animclip");
	//}
	///*{
   ...
   // Wasteland_Undying_Melee_Idle
	{
		...
		SpawnGameObject(player, Vec3(-400.f, 0.f, 0.f), (UINT)LAYER_TYPE::Monster);
	}
